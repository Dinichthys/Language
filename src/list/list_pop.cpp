...
enum ListError ListPopIndex (list_t* const list, void* const element, size_t index)
{
...
enum ListError ListPopFront (list_t* const list, void* const element)
{
    ...
    enum ListError result = ListPopIndex (list, element, list->order [0].previous);
...
enum ListError ListPopBack (list_t* const list, void* const element)
{
    ...
    enum ListError result = ListPopIndex (list, element, list->order [0].next);
